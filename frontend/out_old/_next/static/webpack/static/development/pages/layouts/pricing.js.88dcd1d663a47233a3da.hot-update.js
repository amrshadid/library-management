...
var Pricing = function Pricing() {
    ...
    if (localStorage.getItem("hoarTemplatetoken") != "" && localStorage.getItem("hoarTemplatetoken") != null) {
      if (localStorage.getItem("userInfo")) {
        if (JSON.parse(localStorage.getItem("userInfo")).plan !== "") {
          next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push("/layouts/category");
        } else {
          ...
          axios__WEBPACK_IMPORTED_MODULE_5___default()({
            method: "post",
            url: _constant_api__WEBPACK_IMPORTED_MODULE_9__["default"] + "payment/save_stripe_info/",
            data: formData
        ...
        next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push("/layouts/signUp");
      }
    } else {
      next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push("/layouts/signUp");
    }
      ...
      if (localStorage.getItem("userInfo")) {
        if (JSON.parse(localStorage.getItem("userInfo")).plan) {
          if (JSON.parse(localStorage.getItem("userInfo")).plan != "TR") {
            react_toastify__WEBPACK_IMPORTED_MODULE_6__["toast"].success("You already have an active plan.");
            next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push("/");
          } else {
            localStorage.setItem("requestedPlan", "SU");
            next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push("/layouts/app");
          }
        } else {
          localStorage.setItem("requestedPlan", "SU");
          next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push("/layouts/app");
    ...
    if (localStorage.getItem("hoarTemplatetoken") != "" && localStorage.getItem("hoarTemplatetoken") != null) {
      if (localStorage.getItem("userInfo")) {
        if (JSON.parse(localStorage.getItem("userInfo")).plan === "SU") {
          react_toastify__WEBPACK_IMPORTED_MODULE_6__["toast"].success("You already have an active Single User plan.");
          next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push("/");
        } else {
          localStorage.setItem("requestedInvoicePlan", "SU");
          next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push("/layouts/paymentPage");
        }
      } else {
        next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push("/layouts/signUp");
      }
  ...
  }, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_4__["Col"], (_jsx = {
    sm: "12",
    md: "4",
    className: "mt-1"
  }, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_jsx, "className", "pricing_crr"), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_jsx, "__self", _this), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_jsx, "__source", {
    fileName: _jsxFileName,
    lineNumber: 164,
    columnNumber: 11
  }), _jsx), __jsx(react_slick__WEBPACK_IMPORTED_MODULE_3___default.a, {
  ...
  }, "Invoice"), " ", "My Association)"))))))), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_4__["Col"], {
    sm: "12",
    md: "4",
    className: "mt-1",
    __self: _this,
...
//# sourceMappingURL=pricing.js.88dcd1d663a47233a3da.hot-update.js.map